class LevelSelectionScene
{
    ...
    CreateLevelSelection()
    {
        ...
        this.CreateButton(obj_planet1, planet1, 240, 240, .1, 200, "load_Level1");

        let obj_planet2 = this.CreateObject(350, 200);
        this.CreateButton(obj_planet2, planet2, 600, 600, .1, 200, "load_Level2");

        let obj_planet3 = this.CreateObject(930, 165);
        this.CreateButton(obj_planet3, planet3, 450, 450, .1, 200, "load_Level3");
        
        let obj_planet4 = this.CreateObject(1450, 400);
        this.CreateButton(obj_planet4, planet4, 300, 300, .1, 200, "load_Level4");
        ...
        this.CreateButton(obj_backButton, backButton, 250, 250, .1, -1, "load_MainMenu");
