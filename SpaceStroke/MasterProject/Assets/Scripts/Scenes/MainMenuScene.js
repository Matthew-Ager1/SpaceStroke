class MainMenuScene
{
    ...
    CreateMainMenu()
    {
        ...
        obj_playButton.AddComponent(new ButtonComponent(obj_playButton, 400, 400, "load_LevelSelection", 200));
        ...
        obj_settingsButton.AddComponent(new ButtonComponent(obj_settingsButton, 150, 150, "load_Settings", 150));
